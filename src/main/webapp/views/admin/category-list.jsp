...
<table border="1" width="100%">
    ...
    <c:forEach items="${listcate}" var="cate" varStatus="STT">
        <tr>
            ...
            <c:if test="${not empty cate.images && cate.images.length() >= 5 && cate.images.substring(0,5) == 'https'}">
                <c:url value="${cate.images}" var="imgUrl"></c:url>
            </c:if>
            <c:if test="${empty cate.images || cate.images.length() < 5 || cate.images.substring(0,5) != 'https'}">
